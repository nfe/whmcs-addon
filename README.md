...
Automatize a emissão de nota fiscal eletrônica de serviço diretamente em seu WHMCS através do **[Módulo Nota Fiscal para WHMCS via NFE.io][github-pages]**. Com este módulo, é possível automatizar a rotina de geração e envio de NFSe para seus clientes quando eles realizam o pagamento de uma fatura referente a um pedido ou serviço recorrente, emitir notas a partir de faturas avulsas ou toda vez que um pagamento é recebido no WHMCS por exemplo.
...
* **Instalação:** https://nfe.github.io/whmcs-addon/docs/instalacao
* **Configuração:** https://nfe.github.io/whmcs-addon/docs/configuracao
* **Atualização** (v1.4 para 2.0): https://nfe.github.io/whmcs-addon/docs/atualizacao

## Suporte

Para suporte e ajuda da comunidade, abra uma issue no github em https://github.com/nfe/whmcs-addon/issues

## Como contribuir
(WIP)

[nfeio]: https://nfe.io/
[github-pages]: https://nfe.github.io/whmcs-addon/
